...
화면 구성은 admin 콘솔의 **점검·유지보수 페이지(MaintenancePage) 2탭(펌프 제어 · 밸브 제어=기주 솔레노이드) — 향료/세척 개념 없음(2026-09-03 개편).

  ① 펌프 제어   — 기기 연결 상태 · 시린지 흡입/배출 · [초기화] · 
  ② 밸브 제어   — 신기주/베이스 기주 솔레노이드(식향 전용·GPIO) — ON/OFF(10s 자동닫힘)·N초 열기·상호배타
  ③ 진단 도구 ·  — 단일 포트 속도 진단(흡입/배출 속도·흡입량 조절) · 순차 
